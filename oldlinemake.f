...
c*****declare internally where the good gf lists and the Kurucz lists are
      linepath = 
     .          '/Users/chris/MOOGSTUFF/linemake/mooglists'
...
c*****put in Kurucz hfs/iso information for Sc I, Sc II,
c     Co I, and Cu I, if desired (Kurucz has no hfs/iso info for 
